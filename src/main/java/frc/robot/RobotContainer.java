...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_robotDrive.setDefaultCommand(
        new RunCommand(()->m_robotDrive.arcadeDrive(m_driverController.getLeftY(),
            m_driverController.getRightX()), m_robotDrive));

    // Hopper axle default
    m_hopper.setDefaultCommand(
        new ManualHopper(m_hopper, () -> m_operatorController.getRightY()));

    // Winch default 
    m_climber.setDefaultCommand(
      new ManualClimber(m_climber, () -> m_operatorController.getLeftY()));
